"""
Workflows de Automatización para Hetzner Cloud

Sigue los principios NUPP:
- Open: Workflows abiertos y personalizables
...
class BaseWorkflow:
    """Workflow base para automatización."""
    ...
    def _execute(self, **kwargs) -> Any:
        """Método a implementar por cada workflow."""
...
class BackupWorkflow(BaseWorkflow):
    """Workflow para crear backups de servidores."""

    def _execute(self, server_ids: Optional[List[int]] = None, all_servers: bool = False, **kwargs) -> Dict[str, Any]:
        """
...
class ScaleWorkflow(BaseWorkflow):
    """Workflow para escalar servidores."""
...
class DeployWorkflow(BaseWorkflow):
    """Workflow para despliegue de aplicaciones."""
...
class MonitoringWorkflow(BaseWorkflow):
    """Workflow para monitoreo de recursos."""
